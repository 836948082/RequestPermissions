package com.runtai.requestpermissions;
        ...
        switch (id) {
            ...
            case R.id.btn_request_permission_camera:
                CheckPermission
                        ...
                        .setRationaleMsg("(第二次用户触发时)解释--我需要这些权限")//如果不设置解释信息，setRationaleConfirmText就没有意义(不会显示)
            ...
            case R.id.btn_open_permission_setting:
                if(PermissionUtils.isOverMarshmallow()) {
                    ...
                    Toast.makeText(MainActivity.this, "setting on Android6.0", Toast.LENGTH_SHORT).show();
                }
                break;
